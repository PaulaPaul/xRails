...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { department_id: @instructor.department_id, first_name: @instructor.first_name, hire_date: @instructor.hire_date, last_name: @instructor.last_name, office: @instructor.office }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { department_id: @instructor.department_id, first_name: @instructor.first_name, hire_date: @instructor.hire_date, last_name: @instructor.last_name, office: @instructor.office }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
