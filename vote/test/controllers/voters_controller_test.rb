...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { district: @voter.district, first_name: @voter.first_name, last_name: @voter.last_name, party: @voter.party }
    end
  ...
  test "should update voter" do
    patch :update, id: @voter, voter: { district: @voter.district, first_name: @voter.first_name, last_name: @voter.last_name, party: @voter.party }
    assert_redirected_to voter_path(assigns(:voter))
  end
