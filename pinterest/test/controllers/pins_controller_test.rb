...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { board_id: @pin.board_id, image: @pin.image, name: @pin.name, user_id: @pin.user_id }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { board_id: @pin.board_id, image: @pin.image, name: @pin.name, user_id: @pin.user_id }
    assert_redirected_to pin_path(assigns(:pin))
  end
